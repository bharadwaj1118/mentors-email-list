...
export default async function IndexPage() {
  ...
  return (
    <>
      <section className="container h-screen grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-8">
        ...
        <div>
          ...
          <p className="text-lg mt-4 text-slate-600 max-w-xl">
            ...
            <wbr /> Built with Next.js, TailwindCSS & Alpine.js. You can quickly
            grow your customer experience career with this website.
          </p>
      ...
      {/* <section
        id="features"
        className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24 h-screen"
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Joining our Mentors CX community offers a unique opportunity to gain
            valuable insights, foster meaningful connections, and accelerate
            your professional growth in the dynamic field of customer
            experience.
          </p>
        </div>
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[240px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Career growth & development</h3>
                <p className="text-sm text-muted-foreground">
        ...
        <div className="mx-auto text-center md:max-w-[58rem]">
          <p className="leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Mentors CX also offers resources and additional benefits from
